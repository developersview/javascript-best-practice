...
if (scoreDolphin > scoreKoalas) {
    console.log(
        "Dolphin is the winner 🏆 and their score is : " + Math.ceil(scoreDolphin)
    );
} else if (scoreKoalas > scoreDolphin) {
    console.log(
        "Koalas is the winner 🏆 and their score is : " + Math.ceil(scoreKoalas)
    );
} else {
    console.log("Its a draw!!!..both team score is : " + Math.ceil(scoreDolphin));
}
